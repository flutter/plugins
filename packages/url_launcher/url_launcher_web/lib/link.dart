...
// TODO(mdebbar): Should use PlatformViewFactory.
dynamic get webViewFactory => _LinkViewController._viewFactory;
...
class WebLinkDelegate extends StatefulWidget {
  ...
  /// The [Link] widget built by the app.
  final Link link;
...
class _WebLinkDelegateState extends State<WebLinkDelegate> {
  ...
  Future<void> _onDomClick(html.MouseEvent event) {
    if (!widget.link.uri.hasScheme) {
      ...
      return pluginBinaryMessenger.send(
        'flutter/navigation',
