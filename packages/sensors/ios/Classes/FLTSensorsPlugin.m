...
static void sendData6(Float64 x1, Float64 y1, Float64 z1, Float64 x2, Float64 y2, Float64 z2,
  ...
  [_motionManager
      startDeviceMotionUpdatesToQueue:[[NSOperationQueue alloc] init]
                          withHandler:^(CMDeviceMotion* data, NSError* error) {
                            ...
                            sendData6(acceleration.x * GRAVITY, acceleration.y * GRAVITY,
                                      acceleration.z * GRAVITY, gravity.x * GRAVITY,
                                      gravity.y * GRAVITY, gravity.z * GRAVITY, eventSink);
                          }];
  return nil;
}
