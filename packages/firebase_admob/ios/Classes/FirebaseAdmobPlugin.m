...
- (void)handleMethodCall:(FlutterMethodCall *)call
  ...
  if (mobileAdId == nil) {
    NSString *message = @"all FirebaseAdMobPlugin method calls must specify an "
  ...
  if ([call.method isEqualToString:@"loadBannerAd"]) {
    [self callLoadAd:[BannerAd withId:mobileAdId channel:self.channel]
                call:call
              result:result];
