...
class IOSMediaSelectionTypeData {
  IOSMediaSelectionTypeData({
    required this.value,
  });

  IOSMediaSelectionType value;
  ...
  static IOSMediaSelectionTypeData decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return IOSMediaSelectionTypeData(
      value: IOSMediaSelectionType.values[pigeonMap['value']! as int],
    );
  }
}
...
class ImagePickerApi {
  ...
  Future<List<String?>?> pickMedia(
      ...
      List<IOSMediaSelectionTypeData?> arg_allowedTypes) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
