...
class IOSRetrieveTypeData {
  ...
  static IOSRetrieveTypeData decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return IOSRetrieveTypeData(
      value: IOSRetrieveType.values[pigeonMap['value']! as int],
    );
  }
}
...
class ImagePickerApi {
  ...
  Future<List<String?>?> pickRecentMedia(IOSRetrieveTypeData arg_type,
      MaxSize arg_maxSize, int? arg_imageQuality, int arg_limit) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImagePickerApi.pickRecentMedia', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap = await channel
            .send(<Object?>[arg_type, arg_maxSize, arg_imageQuality, arg_limit])
        as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
