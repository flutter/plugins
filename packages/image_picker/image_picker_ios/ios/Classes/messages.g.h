...
typedef NS_ENUM(NSUInteger, FLTIOSRetrieveType) {
  FLTIOSRetrieveTypeImage = 0,
  FLTIOSRetrieveTypeVideo = 1,
};

@class FLTMaxSize;
@class FLTIOSRetrieveTypeData;
...
@interface FLTIOSRetrieveTypeData : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithValue:(FLTIOSRetrieveType)value;
@property(nonatomic, assign) FLTIOSRetrieveType value;
@end
...
- (void)pickVideoWithSource:(FLTSourceSpecification *)source
                maxDuration:(nullable NSNumber *)maxDurationSeconds
                 completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
- (void)pickRecentMediaWithType:(FLTIOSRetrieveTypeData *)type
                        maxSize:(FLTMaxSize *)maxSize
                        quality:(nullable NSNumber *)imageQuality
