...
- (void)pickMediaWithMaxSize:(FLTMaxSize *)maxSize
                     quality:(nullable NSNumber *)imageQuality
               allowMultiple:(NSNumber *)allowMultiple
                allowedTypes:(NSArray<FLTIOSMediaSelectionTypeData *> *)allowedTypes
                  completion:
                      (void (^)(NSArray<NSString *> *_Nullable, FlutterError *_Nullable))completion;
