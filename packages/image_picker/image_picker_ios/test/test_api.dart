...
class _TestHostImagePickerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is IOSRetrieveTypeData) {
      buffer.putUint8(128);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128:
        return IOSRetrieveTypeData.decode(readValue(buffer)!);
...
abstract class TestHostImagePickerApi {
  ...
  static void setup(TestHostImagePickerApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.ImagePickerApi.pickRecentMedia', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickRecentMedia was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final IOSRetrieveTypeData? arg_type =
              (args[0] as IOSRetrieveTypeData?);
          assert(arg_type != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickRecentMedia was null, expected non-null IOSRetrieveTypeData.');
          final MaxSize? arg_maxSize = (args[1] as MaxSize?);
          assert(arg_maxSize != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickRecentMedia was null, expected non-null MaxSize.');
          final int? arg_imageQuality = (args[2] as int?);
          final int? arg_limit = (args[3] as int?);
          assert(arg_limit != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickRecentMedia was null, expected non-null int.');
          final List<String?>? output = await api.pickRecentMedia(
              arg_type!, arg_maxSize!, arg_imageQuality, arg_limit!);
          return <Object?, Object?>{'result': output};
        });
      }
    }
