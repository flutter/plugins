...
class _TestHostImagePickerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is IOSMediaSelectionTypeData) {
      buffer.putUint8(128);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128:
        return IOSMediaSelectionTypeData.decode(readValue(buffer)!);
...
abstract class TestHostImagePickerApi {
  ...
  Future<List<String?>?> pickMedia(MaxSize maxSize, int? imageQuality,
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final MaxSize? arg_maxSize = (args[0] as MaxSize?);
          assert(arg_maxSize != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickMedia was null, expected non-null MaxSize.');
          final int? arg_imageQuality = (args[1] as int?);
          final bool? arg_allowMultiple = (args[2] as bool?);
          assert(arg_allowMultiple != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickMedia was null, expected non-null bool.');
          final List<IOSMediaSelectionTypeData?>? arg_allowedTypes =
              (args[3] as List<Object?>?)?.cast<IOSMediaSelectionTypeData?>();
          assert(arg_allowedTypes != null,
              'Argument for dev.flutter.pigeon.ImagePickerApi.pickMedia was null, expected non-null List<IOSMediaSelectionTypeData?>.');
          final List<String?>? output = await api.pickMedia(arg_maxSize!,
              arg_imageQuality, arg_allowMultiple!, arg_allowedTypes!);
          return <Object?, Object?>{'result': output};
        });
      }
    }
