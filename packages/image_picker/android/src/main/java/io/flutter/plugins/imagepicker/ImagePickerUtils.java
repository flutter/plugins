...
final class ImagePickerUtils {
    ...
    /**
     * Camera permission need request if it present in manifest, because
     * for M or great for take Photo ar Video by intent need it permission,
     * even if the camera permission is not used.
     * <p>
    ...
    static boolean needRequestCameraPermission(Context context) {
        ...
        return greatOrEqualM && ImagePickerUtils.isPermissionPresentInManifest(context, Manifest.permission.CAMERA);
    }
}
