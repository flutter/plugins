...
// in image_picker/example/ios/.symlinks/plugins/image_picker/test/image_picker_test.dart.
...
class MockImagePickerPlatform extends _i1.Mock
  ...
  @override
  _i4.Future<List<_i5.XFile>?> getMedia({_i2.MediaSelectionOptions? options}) =>
      (super.noSuchMethod(Invocation.method(#getMedia, [], {#options: options}),
              returnValue: Future<List<_i5.XFile>?>.value())
          as _i4.Future<List<_i5.XFile>?>);
  @override
...
/// A class which mocks [LostData].
///
/// See the documentation for Mockito's code generation for more information.
class MockLostData extends _i1.Mock implements _i2.LostData {
  MockLostData() {
    _i1.throwOnMissingStub(this);
  }
