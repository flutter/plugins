...
* Bump `image_picker_platform_interface` dependency, a `dart.io` free platform interface.
* Refactor method `retrieveLostData()` to not use class `File` within platform interface.
