...
Downloaded by pub (not CocoaPods).
  ...
  s.source           = { :http => 'https://github.com/flutter/plugins/tree/master/packages/in_app_purchase/in_app_purchase_macos' }
  ...
  s.source_files = '../storekit/Classes/**/*'
  s.public_header_files = '../storekit/Classes/**/*.h'
