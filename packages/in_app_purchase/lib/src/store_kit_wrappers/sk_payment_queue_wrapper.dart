...
class SKPaymentQueueWrapper {
  ...
  void setTransactionObserver(SKTransactionObserverWrapper observer) {
    _observer = observer;
    channel.invokeMethod('-[SKPaymentQueue observerDidSet:]');
  }
  ...
  Future<void> addPayment(SKPaymentWrapper payment) {
    assert(_observer != null,
        '[in_app_purchase]: Trying to add a payment without an observer. Observer must be set using `setTransactionObserver` right at the app launch.');
  ...
  Future<void> finishTransaction(SKPaymentTransactionWrapper transaction) {
    return channel.invokeMethod(
