...
/// An invisible player layer used to access the pixel buffers in protected video streams in
/// iOS 16 (older iOS could be patched as well).
...
- (instancetype)initWithPlayerItem:(AVPlayerItem *)item
  ...
  // with blank video for encrypted video streams. An invisible AVPlayerLayer is used to overwrite
  // the protection of pixel buffers in those streams.
