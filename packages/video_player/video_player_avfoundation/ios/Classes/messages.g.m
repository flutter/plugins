...
+ (FLTPreparePictureInPictureMessage *)fromMap:(NSDictionary *)dict {
  ...
  pigeonResult.textureId = GetNullableObject(dict, @"textureId");
  NSAssert(pigeonResult.textureId != nil, @"");
  pigeonResult.enableStartPictureInPictureAutomaticallyFromInline = GetNullableObject(dict, @"enableStartPictureInPictureAutomaticallyFromInline");
...
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.top ? self.top : [NSNull null]), @"top", (self.left ? self.left : [NSNull null]), @"left", (self.width ? self.width : [NSNull null]), @"width", (self.height ? self.height : [NSNull null]), @"height", nil];
}
@end
...
- (void)writeValue:(id)value 
{
  ...
  if ([value isKindOfClass:[FLTPiPRect class]]) {
    [self writeByte:131];
    [self writeValue:[value toMap]];
  } else 
