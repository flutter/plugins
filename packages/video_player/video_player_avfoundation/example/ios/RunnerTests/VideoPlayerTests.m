...
- (void)testSetMaxVideoResolutionWithWrongWidth {
  NSObject<FlutterPluginRegistry> *registry =
      (NSObject<FlutterPluginRegistry> *)[[UIApplication sharedApplication] delegate];
  NSObject<FlutterPluginRegistrar> *registrar =
      [registry registrarForPlugin:@"TestSetMaxVideoResolutionWithWrongWidth"];
...
- (void)testSetMaxVideoResolutionWithWrongHeight {
  NSObject<FlutterPluginRegistry> *registry =
      (NSObject<FlutterPluginRegistry> *)[[UIApplication sharedApplication] delegate];
  NSObject<FlutterPluginRegistrar> *registrar =
      [registry registrarForPlugin:@"TestSetMaxVideoResolutionWithWrongHeight"];
