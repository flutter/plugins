...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class BitrateMessage {
    private @NonNull Long textureId;
    public @NonNull Long getTextureId() { return textureId; }
    public void setTextureId(@NonNull Long setterArg) {
      if (setterArg == null) {
    ...
    private @NonNull Double bitrate;
    public @NonNull Double getBitrate() { return bitrate; }
    public void setBitrate(@NonNull Double setterArg) {
      if (setterArg == null) {
    ...
    public static class Builder {
      ...
      public @NonNull Builder setBitrate(@NonNull Double setterArg) {
        this.bitrate = setterArg;
        return this;
      }
      public @NonNull BitrateMessage build() {
        BitrateMessage pigeonReturn = new BitrateMessage();
        pigeonReturn.setTextureId(textureId);
    ...
    static @NonNull BitrateMessage fromMap(@NonNull Map<String, Object> map) {
      BitrateMessage pigeonResult = new BitrateMessage();
      Object textureId = map.get("textureId");
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer)textureId : (Long)textureId));
      Object bitrate = map.get("bitrate");
      pigeonResult.setBitrate((Double)bitrate);
      return pigeonResult;
    }
  }
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        case (byte)128:         
          return BitrateMessage.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      if (value instanceof BitrateMessage) {
        stream.write(128);
        writeValue(stream, ((BitrateMessage) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.setBitrate", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              BitrateMessage msgArg = (BitrateMessage)args.get(0);
              if (msgArg == null) {
                throw new NullPointerException("msgArg unexpectedly null.");
              }
              api.setBitrate(msgArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
