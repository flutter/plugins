...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AndroidVideoPlayerApi.setBitrate', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setBitrate was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final BitrateMessage? arg_msg = (args[0] as BitrateMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AndroidVideoPlayerApi.setBitrate was null, expected non-null BitrateMessage.');
