...
public class VideoPlayerPlugin implements FlutterPlugin, VideoPlayerApi {
  ...
  public TextureMessage create() {
    ...
    VideoPlayer player = new VideoPlayer(flutterState.applicationContext, eventChannel, handle);
  ...
  public void setDataSource(DataSourceMessage arg) {
    ...
    if (arg.getAsset() != null) {
      ...
      player.setDataSource(
          flutterState.applicationContext, key, "asset:///" + assetLookupKey, null);
    } else {
      player.setDataSource(flutterState.applicationContext, key, arg.getUri(), arg.getFormatHint());
    }
  }
