...
@class FLTAndroidOptionsMessage;
...
@interface FLTAndroidOptionsMessage : NSObject 
@property(nonatomic, strong, nullable) NSNumber * mp4ExtractorSkipEditLists;
@end
...
-(void)setAndroidOptions:(FLTAndroidOptionsMessage*)input error:(FlutterError * _Nullable * _Nonnull)error;
@end
