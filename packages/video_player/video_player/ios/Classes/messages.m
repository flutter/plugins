...
- (NSDictionary *)toMap;
@end
@interface FLTTrackSelectionsMessage ()
+ (FLTTrackSelectionsMessage *)fromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
...
@implementation FLTTrackSelectionsMessage
+ (FLTTrackSelectionsMessage *)fromMap:(NSDictionary *)dict {
  FLTTrackSelectionsMessage *result = [[FLTTrackSelectionsMessage alloc] init];
  result.textureId = dict[@"textureId"];
  if ((NSNull *)result.textureId == [NSNull null]) {
    result.textureId = nil;
  }
  result.trackId = dict[@"trackId"];
  if ((NSNull *)result.trackId == [NSNull null]) {
    result.trackId = nil;
  }
  result.trackSelections = dict[@"trackSelections"];
  if ((NSNull *)result.trackSelections == [NSNull null]) {
    result.trackSelections = nil;
  }
  return result;
}
- (NSDictionary *)toMap {
  return [NSDictionary
      dictionaryWithObjectsAndKeys:(self.textureId ? self.textureId : [NSNull null]), @"textureId",
                                   (self.trackId ? self.trackId : [NSNull null]), @"trackId",
                                   (self.trackSelections ? self.trackSelections : [NSNull null]),
                                   @"trackSelections", nil];
}
@end
...
void FLTVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<FLTVideoPlayerApi> api) {
  ...
  {
    FlutterBasicMessageChannel *channel = [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.trackSelections"
               binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FLTTextureMessage *input = [FLTTextureMessage fromMap:message];
        FlutterError *error;
        FLTTrackSelectionsMessage *output = [api trackSelections:input error:&error];
        callback(wrapResult([output toMap], error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  {
    FlutterBasicMessageChannel *channel = [FlutterBasicMessageChannel
        messageChannelWithName:@"dev.flutter.pigeon.VideoPlayerApi.setTrackSelection"
               binaryMessenger:binaryMessenger];
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FLTTrackSelectionsMessage *input = [FLTTrackSelectionsMessage fromMap:message];
        FlutterError *error;
        [api setTrackSelection:input error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
