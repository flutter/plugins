...
package io.flutter.plugins.sensor;
 ...
 * SensorPlugin
 */
public class SensorPlugin implements EventChannel.StreamHandler {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    accelerometerChannel.setStreamHandler(
        new SensorPlugin(registrar.activity(), Sensor.TYPE_ACCELEROMETER));
    ...
    gyroscopeChannel.setStreamHandler(
        new SensorPlugin(registrar.activity(), Sensor.TYPE_GYROSCOPE));
  }
  ...
  private SensorPlugin(Activity activity, int sensorType) {
