...
void main() {
  ...
  test('setFolder should call dialog setFolder with the provided path', () {
    ...
    when(mockShellWin32Api.createItemFromParsingName(any, any, any))
        .thenReturn(S_OK);
  ...
  test('[DialogMode == Save] show should return the file path', () {
    ...
    when(mockShellWin32Api.releaseShellItem(any)).thenReturn(0);
...
void setDefaultMocks(
  ...
  when(mockFileDialogController.release()).thenReturn(defaultReturnValue);
}
