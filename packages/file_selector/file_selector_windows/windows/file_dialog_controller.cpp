...
HRESULT FileDialogController::GetOptions(FILEOPENDIALOGOPTIONS* out_options) {
...
HRESULT FileDialogController::GetResult(IShellItem** out_item) {
  return dialog_->GetResult(out_item);
}

HRESULT FileDialogController::GetResults(IShellItemArray** out_items) {
