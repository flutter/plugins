...
//      exoPlayer.setAudioSurface(surface);
    ...
    private void sendInitialized() {
      if (isInitialized) {
        ...
        if (exoPlayer.getAudioFormat() != null) {
          ...
          int rotationDegrees = audioFormat.rotationDegrees;
          // Switch the width/height if audio was taken in portrait mode
          if (rotationDegrees == 90 || rotationDegrees == 270) {
            width = exoPlayer.getAudioFormat().height;
            height = exoPlayer.getAudioFormat().width;
          }
