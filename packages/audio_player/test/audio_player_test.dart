...
class FakeController extends ValueNotifier<AudioPlayerValue>
    implements AudioPlayerController {
  FakeController() : super(AudioPlayerValue(duration: null));
...
void main() {
  testWidgets('update texture', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(AudioPlayer(controller));
  ...
  testWidgets('update controller', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(AudioPlayer(controller1));
    expect(
    ...
    await tester.pumpWidget(AudioPlayer(controller2));
    expect(
        find.byWidgetPredicate(
