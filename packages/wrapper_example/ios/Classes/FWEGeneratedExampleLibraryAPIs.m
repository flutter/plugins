...
NSObject<FlutterMessageCodec> *FWEBaseObjectHostApiGetCodec() {
  ...
  dispatch_once(&sPred, ^{
    FWEBaseObjectHostApiCodecReaderWriter *readerWriter =
        [[FWEBaseObjectHostApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}

void FWEBaseObjectHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
                               NSObject<FWEBaseObjectHostApi> *api) {
  {
    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(disposeIdentifier:error:)],
          @"FWEBaseObjectHostApi api (%@) doesn't respond to @selector(disposeIdentifier:error:)",
          api);
...
NSObject<FlutterMessageCodec> *FWEBaseObjectFlutterApiGetCodec() {
  ...
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FWEBaseObjectFlutterApiCodecReaderWriter *readerWriter =
        [[FWEBaseObjectFlutterApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}
...
- (void)disposeIdentifier:(NSNumber *)arg_identifier
...
NSObject<FlutterMessageCodec> *FWEMyClassHostApiGetCodec() {
  ...
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FWEMyClassHostApiCodecReaderWriter *readerWriter =
        [[FWEMyClassHostApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}

void FWEMyClassHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
                            NSObject<FWEMyClassHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.MyClassHostApi.create"
                                         binaryMessenger:binaryMessenger
                                                   codec:FWEMyClassHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(createIdentifier:
                                                    primitiveField:classFieldIdentifier:error:)],
                @"FWEMyClassHostApi api (%@) doesn't respond to "
                @"@selector(createIdentifier:primitiveField:classFieldIdentifier:error:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_identifier = GetNullableObjectAtIndex(args, 0);
        ...
        FlutterError *error;
        [api createIdentifier:arg_identifier
                  primitiveField:arg_primitiveField
            classFieldIdentifier:arg_classFieldIdentifier
                           error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
  ...
  }
  {
    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(myStaticMethodWithError:)],
          @"FWEMyClassHostApi api (%@) doesn't respond to @selector(myStaticMethodWithError:)",
          api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
        ...
        binaryMessenger:binaryMessenger
                  codec:FWEMyClassHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(myMethodIdentifier:
                                                      primitiveParam:classParamIdentifier:error:)],
                @"FWEMyClassHostApi api (%@) doesn't respond to "
                @"@selector(myMethodIdentifier:primitiveParam:classParamIdentifier:error:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_identifier = GetNullableObjectAtIndex(args, 0);
        ...
        FlutterError *error;
        [api myMethodIdentifier:arg_identifier
                  primitiveParam:arg_primitiveParam
            classParamIdentifier:arg_classParamIdentifier
                           error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
        ...
        binaryMessenger:binaryMessenger
                  codec:FWEMyClassHostApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(attachClassFieldIdentifier:
                                                        classFieldIdentifier:error:)],
                @"FWEMyClassHostApi api (%@) doesn't respond to "
                @"@selector(attachClassFieldIdentifier:classFieldIdentifier:error:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_identifier = GetNullableObjectAtIndex(args, 0);
        ...
        FlutterError *error;
        [api attachClassFieldIdentifier:arg_identifier
                   classFieldIdentifier:arg_classFieldIdentifier
                                  error:&error];
        callback(wrapResult(nil, error));
      }];
...
NSObject<FlutterMessageCodec> *FWEMyClassFlutterApiGetCodec() {
  ...
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FWEMyClassFlutterApiCodecReaderWriter *readerWriter =
        [[FWEMyClassFlutterApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}
...
- (void)createIdentifier:(NSNumber *)arg_identifier
          primitiveField:(NSString *)arg_primitiveField
              completion:(void (^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel = [FlutterBasicMessageChannel
      messageChannelWithName:@"dev.flutter.pigeon.MyClassFlutterApi.create"
             binaryMessenger:self.binaryMessenger
                       codec:FWEMyClassFlutterApiGetCodec()];
  [channel sendMessage:@[ arg_identifier ?: [NSNull null], arg_primitiveField ?: [NSNull null] ]
                 reply:^(id reply) {
                   completion(nil);
                 }];
}
- (void)myCallbackMethodIdentifier:(NSNumber *)arg_identifier
                        completion:(void (^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel = [FlutterBasicMessageChannel
...
NSObject<FlutterMessageCodec> *FWEMyOtherClassHostApiGetCodec() {
  ...
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FWEMyOtherClassHostApiCodecReaderWriter *readerWriter =
        [[FWEMyOtherClassHostApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}

void FWEMyOtherClassHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
                                 NSObject<FWEMyOtherClassHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(createIdentifier:error:)],
          @"FWEMyOtherClassHostApi api (%@) doesn't respond to @selector(createIdentifier:error:)",
          api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_identifier = GetNullableObjectAtIndex(args, 0);
...
NSObject<FlutterMessageCodec> *FWEMyOtherClassFlutterApiGetCodec() {
  ...
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FWEMyOtherClassFlutterApiCodecReaderWriter *readerWriter =
        [[FWEMyOtherClassFlutterApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}
...
NSObject<FlutterMessageCodec> *FWEMyClassSubclassHostApiGetCodec() {
  ...
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FWEMyClassSubclassHostApiCodecReaderWriter *readerWriter =
        [[FWEMyClassSubclassHostApiCodecReaderWriter alloc] init];
    sSharedObject = [FlutterStandardMessageCodec codecWithReaderWriter:readerWriter];
  });
  return sSharedObject;
}

void FWEMyClassSubclassHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
                                    NSObject<FWEMyClassSubclassHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
    ...
    if (api) {
      NSCAssert([api respondsToSelector:@selector(createIdentifier:
                                                    primitiveField:classFieldIdentifier:error:)],
                @"FWEMyClassSubclassHostApi api (%@) doesn't respond to "
                @"@selector(createIdentifier:primitiveField:classFieldIdentifier:error:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
