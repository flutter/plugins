...
abstract class TestMyClassSubclassHostApi {
  ...
  void create(int identifier, String primitiveField, int classFieldIdentifier);
  static void setup(TestMyClassSubclassHostApi? api,
      {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.MyClassSubclassHostApi.create was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.MyClassSubclassHostApi.create was null, expected non-null int.');
          final String? arg_primitiveField = (args[1] as String?);
          assert(arg_primitiveField != null,
              'Argument for dev.flutter.pigeon.MyClassSubclassHostApi.create was null, expected non-null String.');
          final int? arg_classFieldIdentifier = (args[2] as int?);
          assert(arg_classFieldIdentifier != null,
              'Argument for dev.flutter.pigeon.MyClassSubclassHostApi.create was null, expected non-null int.');
          api.create(
