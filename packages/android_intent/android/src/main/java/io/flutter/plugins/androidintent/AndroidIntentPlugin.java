...
public final class AndroidIntentPlugin implements FlutterPlugin, ActivityAware {
   ...
   *
   * <p>
   * See {@code io.flutter.plugins.androidintentexample.MainActivity} for an
   * example.
   */
   ...
   * {@code io.flutter.plugin.common} package.
   *
   * <p>
   * Calling this automatically initializes the plugin. However plugins
   * initialized this way won't react to changes in activity or context, unlike
   * {@link AndroidIntentPlugin}.
   */
