...
- (void)testAvailableCamerasShouldReturnAllCamerasOnMultiCameraIPhone {
    ...
    // iPhone 13 Cameras:
    id wideAngleCamera =         [[AVCaptureDeviceMock alloc] initWithId:@"0" position:AVCaptureDevicePositionBack];
    id frontFacingCamera =       [[AVCaptureDeviceMock alloc] initWithId:@"1" position:AVCaptureDevicePositionFront];
    id ultraWideCamera =         [[AVCaptureDeviceMock alloc] initWithId:@"2" position:AVCaptureDevicePositionBack];
    id telephotoCamera =         [[AVCaptureDeviceMock alloc] initWithId:@"3" position:AVCaptureDevicePositionBack];
    
    NSMutableArray *requiredTypes = [NSMutableArray array];
    [requiredTypes addObjectsFromArray:@[AVCaptureDeviceTypeBuiltInWideAngleCamera,AVCaptureDeviceTypeBuiltInTelephotoCamera]];
    ...
    OCMStub([discoverySessionMock discoverySessionWithDeviceTypes:[NSArray arrayWithArray:requiredTypes]
    ...
    FlutterMethodCall *call = [FlutterMethodCall
                               methodCallWithMethodName:@"availableCameras"
                               arguments:nil
    ];
