...
public class ExposureOffset implements CameraFeature<ExposureOffsetValue> {
    ...
    /**
     * Returns the exposure offset step size. This is the smallest amount which the
     * exposure offset can be changed.
     *
     * Example: if this has a value of 0.5, then an aeExposureCompensation setting of
     * -2 means that the actual AE offset is -1.
     * @param cameraProperties
     * @return
     */
    private double getExposureOffsetStepSize(CameraProperties cameraProperties) {
