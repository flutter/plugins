...
public class Camera {
     ...
     */
    private final boolean mAutoFocusSupported = false;
    /**
        ...
        CameraCaptureSession.StateCallback callback =
                new CameraCaptureSession.StateCallback() {
                    ...
                    public void onConfigured(@NonNull CameraCaptureSession session) {
                        ...
                        updateFpsRange();
                        updateFocus(mPreviewRequestBuilder);
...
//            captureSession.setRepeatingRequest(mPreviewRequestBuilder.build(), null, mBackgroundHandler);
     ...
     * TODO: call when activity resumed
     */
    ...
    /**
     * Sync the requestBuilder exposure mode setting ot the current exposure mode setting of the camera.
     */
    ...
    void updateFlash(CaptureRequest.Builder requestBuilder) {
        ...
        switch (currentFlashMode) {
            ...
            // TODO: to be implemented someday. Need to add it to dart and iOS.
//      case autoRedEye:
//        requestBuilder.set(CaptureRequest.CONTROL_AE_MODE,
...
//        break;
    ...
    /**
     * Trigger auto focus to start and refresh preview capture session.
     */
    private void startAutoFocus() {
        ...
        try {
            ...
            pictureCaptureRequest.error("cannotStartAutofocus", e.getMessage(), null);
        }
    }
    ...
    private void unlockAutoFocus() {
        ...
        // Reset AE state. If we don't call this then the preview won't show AE again.
        mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_PRECAPTURE_TRIGGER,
                CaptureRequest.CONTROL_AE_PRECAPTURE_TRIGGER_IDLE);
    ...
    /**
     * Dart handler when it's time to set a new flash mode. This will try to set a new
     * flash mode to the current camera.
     *
     * @param result
     * @param newMode
     * @throws CameraAccessException
    ...
    public void setFlashMode(@NonNull final Result result, FlashMode newMode)
            throws CameraAccessException {
        // Check if the current camera can modify the flash mode.
    ...
    private void updateFocus(CaptureRequest.Builder requestBuilder) {
        if (useAutoFocus) {
