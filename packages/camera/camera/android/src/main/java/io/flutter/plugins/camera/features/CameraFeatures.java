...
/**
 * This is all of our available features in the camera. Used in the features map
 * of the camera to safely access feature class instances when we need to change
