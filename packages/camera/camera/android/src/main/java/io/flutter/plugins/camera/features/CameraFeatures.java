...
/**
 * These are all of our available features in the camera. Used in the Camera to access
 * all features in a simpler way.
 */
public class CameraFeatures {
    ...
    private <T extends CameraFeature> T getFeature(String key) {
        return (T) featureMap.get(key);
    }
    ...
    public ExposureLockFeature getExposureLock() {
        return getFeature(EXPOSURE_LOCK);
    }
    ...
    public ExposureOffsetFeature getExposureOffset() {
        return getFeature(EXPOSURE_OFFSET);
    }
    ...
    public ExposurePointFeature getExposurePoint() {
        return getFeature(EXPOSURE_POINT);
    }
    ...
    public NoiseReductionFeature getNoiseReduction() {
        return getFeature(NOISE_REDUCTION);
    }
    ...
    public SensorOrientationFeature getSensorOrientation() {
        return getFeature(SENSOR_ORIENTATION);
    }
