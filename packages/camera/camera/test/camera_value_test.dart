...
void main() {
  group('camera_value', () {
    ...
    test('Can be created as uninitialized', () {
      const CameraValue cameraValue = CameraValue.uninitialized(FakeController.fakeDescription);
    ...
    test('Can be copied with isInitialized', () {
      const CameraValue cv = CameraValue.uninitialized(FakeController.fakeDescription);
