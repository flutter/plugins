...
public class MediaRecorderBuilderTest {
    ...
    public void build_Should_set_values_in_correct_order_When_audio_is_disabled() throws IOException {
        ...
        MediaRecorderBuilder.MediaRecorderFactory mockFactory = mock(MediaRecorderBuilder.MediaRecorderFactory.class);
        ...
        when(mockFactory.makeMediaRecorder())
        ...
        inOrder.verify(recorder).setVideoSize(recorderProfile.videoFrameWidth, recorderProfile.videoFrameHeight);
