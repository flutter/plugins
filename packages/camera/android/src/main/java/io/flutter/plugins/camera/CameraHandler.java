...
public class CameraHandler implements MethodCallHandler {
  ...
  CameraHandler(Registrar registrar, FlutterView view, Activity activity) {
    setup(registrar);
    ...
    this.activityLifecycleCallbacks =
        new Application.ActivityLifecycleCallbacks() {
          ...
          public void onActivityResumed(Activity activity) {
            ...
            if (activity != CameraHandler.this.activity) {
              return;
            }
  ...
  private void setup(Registrar registrar) {
