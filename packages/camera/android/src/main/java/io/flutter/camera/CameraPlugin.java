...
public class CameraPlugin implements MethodCallHandler {
    ...
    private Size getBestPreviewSize(StreamConfigurationMap streamConfigurationMap, Size minPreviewSize, Size captureSize) {
        ...
        switch (call.method) {
            ...
            case "create": {
                ...
                final EventChannel eventChannel =
                        new EventChannel(registrar.messenger(), "flutter.io/cameraPlugin/cameraEvents" + surfaceTexture.id());
