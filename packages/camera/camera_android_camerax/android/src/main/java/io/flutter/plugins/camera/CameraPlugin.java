  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    instanceManager =
        InstanceManager.open(
            identifier -> {
              new GeneratedCameraXAPIs.JavaObjectFlutterApi(binaryMessenger)
                  .dispose(identifier, reply -> {});
            });

    JavaObjectHostApi.setup(binaryMessenger, new JavaObjectHostApiImpl(instanceManager));
    ProcessCameraProviderHostApi.setup(binaryMessenger, new ProcessCameraProviderHostApiImpl(binaryMessenger, instanceManager));
  }
