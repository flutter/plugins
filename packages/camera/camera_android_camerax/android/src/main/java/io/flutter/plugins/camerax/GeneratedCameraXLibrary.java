...
public class GeneratedCameraXLibrary {
  ...
  public interface PreviewHostApi {
    ...
    @NonNull
    Map<String, Long> getResolutionInfo(@NonNull Long identifier);
          ...
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  ...
                  if (targetRotationArg == null) {
                    throw new NullPointerException("targetRotationArg unexpectedly null.");
                  }
  ...
  private static class PreviewFlutterApiCodec extends StandardMessageCodec {
    public static final PreviewFlutterApiCodec INSTANCE = new PreviewFlutterApiCodec();

    private PreviewFlutterApiCodec() {}
  }

  /** Generated class from Pigeon that represents Flutter messages that can be called from Java. */
  public static class PreviewFlutterApi {
    private final BinaryMessenger binaryMessenger;

    public PreviewFlutterApi(BinaryMessenger argBinaryMessenger) {
      this.binaryMessenger = argBinaryMessenger;
    }
    ...
    public void create(
        ...
        @NonNull Long targetRotationArg,
        @Nullable Map<String, Long> targetResolutionArg,
        Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.PreviewFlutterApi.create", getCodec());
      channel.send(
          new ArrayList<Object>(
              Arrays.asList(identifierArg, targetRotationArg, targetResolutionArg)),
          channelReply -> {
            callback.reply(null);
          });
    }
  ...
  private static class CameraControlHostApiCodec extends StandardMessageCodec {
    public static final CameraControlHostApiCodec INSTANCE = new CameraControlHostApiCodec();

    private CameraControlHostApiCodec() {}
  }
  ...
  public interface CameraControlHostApi {
    ...
    static MessageCodec<Object> getCodec() {
      return CameraControlHostApiCodec.INSTANCE;
    }
     ...
     * `binaryMessenger`.
     */
    static void setup(BinaryMessenger binaryMessenger, CameraControlHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
          ...
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  ...
                  api.setZoomRatio(
                      (identifierArg == null) ? null : identifierArg.longValue(),
                      (ratioArg == null) ? null : ratioArg.longValue());
                  wrapped.put("result", null);
                } catch (Error | RuntimeException exception) {
                  wrapped.put("error", wrapError(exception));
                }
  ...
  private static class CameraControlFlutterApiCodec extends StandardMessageCodec {
    public static final CameraControlFlutterApiCodec INSTANCE = new CameraControlFlutterApiCodec();

    private CameraControlFlutterApiCodec() {}
  }
  ...
  public static class CameraControlFlutterApi {
    ...
    public CameraControlFlutterApi(BinaryMessenger argBinaryMessenger) {
      this.binaryMessenger = argBinaryMessenger;
    }
    ...
    static MessageCodec<Object> getCodec() {
      return CameraControlFlutterApiCodec.INSTANCE;
    }
  ...
  public static class SystemServicesFlutterApi {
    ...
    public void onCameraPermissionsRequestResult(
        @Nullable String errorCodeArg, @Nullable String errorMessageArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger,
              "dev.flutter.pigeon.SystemServicesFlutterApi.onCameraPermissionsRequestResult",
              getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(errorCodeArg, errorMessageArg)),
          channelReply -> {
            callback.reply(null);
          });
    }
