...
public class GeneratedCameraXLibrary {
  ...
  public interface CameraSelectorHostApi {
    @NonNull Long requireLensFacing(@NonNull Long lensDirection);
    @NonNull List<Long> filter(@NonNull Long instanceId, @NonNull List<Long> cameraInfoIds);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              Long output = api.requireLensFacing((lensDirectionArg == null) ? null : lensDirectionArg.longValue());
              wrapped.put("result", output);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              List<Long> output = api.filter((instanceIdArg == null) ? null : instanceIdArg.longValue(), cameraInfoIdsArg);
              wrapped.put("result", output);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
