...
public class GeneratedCameraXLibrary {
  ...
  public interface PreviewHostApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, PreviewHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PreviewHostApi.setTargetRotation", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              api.setTargetRotation((identifierArg == null) ? null : identifierArg.longValue(), (targetRotationArg == null) ? null : targetRotationArg.longValue());
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              List<Long> output = api.getResolutionInfo((identifierArg == null) ? null : identifierArg.longValue());
              wrapped.put("result", output);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
  ...
  public interface CameraHostApi {
    @NonNull Long getCameraControl(@NonNull Long identifier);
    ...
    static void setup(BinaryMessenger binaryMessenger, CameraHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.CameraHostApi.getCameraControl", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
  ...
  public interface CameraControlHostApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, CameraControlHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.CameraControlHostApi.setZoomRatio", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
