...
public class ImageStreamReaderUtils {
  /**
   * Copyright (c) 2019 Dmitry Gordin Based on:
   * https://github.com/gordinmitya/yuv2buf/blob/master/yuv2buf/src/main/java/ru/gordinmitya/yuv2buf/Yuv.java
   *
   * <p>Will remove the padding from a given image plane and return the fixed buffer.
   *
   ...
   * https://github.com/gordinmitya/yuv2buf/blob/master/yuv2buf/src/main/java/ru/gordinmitya/yuv2buf/Yuv.java
   *
   * <p>Copies part of a buffer to a new buffer, used to trim the padding.
   *
