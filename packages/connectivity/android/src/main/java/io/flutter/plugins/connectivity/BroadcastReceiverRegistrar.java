...
public interface BroadcastReceiverRegistrar {
    ...
    /**
     * Triggered when it is ready for the BroadcastReceiver to be registered. Register the receiver in this method body.
     *
    ...
    /**
     * Triggered when it is ready for the BroadcastReceiver to be unregistered. Unregister the receiver in this method body.
     *
     ...
     */
    @NonNull BroadcastReceiver createReceiver(@NonNull final EventChannel.EventSink events);
}
