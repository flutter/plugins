...
class espressoWidgetsFlutterBinding extends LiveTestWidgetsFlutterBinding {
  espressoWidgetsFlutterBinding() {
    ...
    tearDownAll(() async {
      try {
        ...
        print('Warning: espresso test plugin was not detected.');
      }
  ...
  static WidgetsBinding ensureInitialized() {
    ...
    assert(WidgetsBinding.instance is espressoWidgetsFlutterBinding);
    return WidgetsBinding.instance;
  }

  static const MethodChannel _channel = MethodChannel('plugins.flutter.io/espresso');
