...
import io.flutter.plugins.webviewflutterandroid.DownloadListenerHostApiImpl.DownloadListenerImpl;
import io.flutter.plugins.webviewflutterandroid.WebChromeClientHostApiImpl.WebChromeClientImpl;
import io.flutter.plugins.webviewflutterandroid.WebViewClientHostApiImpl.WebViewClientImpl;
import io.flutter.plugins.webviewflutterandroid.WebViewHostApiImpl.InputAwareWebViewPlatformView;
import io.flutter.plugins.webviewflutterandroid.WebViewHostApiImpl.WebViewPlatformView;
...
public class WebViewTest {
  ...
  public void evaluateJavaScript() {
    ...
    testHostApiImpl.evaluateJavascript(
        0L,
        "2 + 2",
        new GeneratedAndroidWebKit.Result<String>() {
          @Override
