...
import io.flutter.plugins.webviewflutterandroid.WebViewClientHostApiImpl.ReleasableWebViewClient;
...
public class WebViewHostApiImpl implements WebViewHostApi {
  ...
  public void evaluateJavascript(
      Long instanceId, String javascriptString, GeneratedAndroidWebKit.Result<String> result) {
    final WebView webView = (WebView) instanceManager.getInstance(instanceId);
