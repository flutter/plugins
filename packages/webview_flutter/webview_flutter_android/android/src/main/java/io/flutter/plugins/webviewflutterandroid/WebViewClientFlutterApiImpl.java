...
import io.flutter.plugins.webviewflutterandroid.GeneratedAndroidWebKit.WebViewClientFlutterApi;
...
public class WebViewClientFlutterApiImpl extends WebViewClientFlutterApi {
  ...
  static GeneratedAndroidWebKit.WebResourceErrorData createWebResourceErrorData(
      WebResourceError error) {
    final GeneratedAndroidWebKit.WebResourceErrorData errorData =
        new GeneratedAndroidWebKit.WebResourceErrorData();
  ...
  static GeneratedAndroidWebKit.WebResourceRequestData createWebResourceRequestData(
      WebResourceRequest request) {
    final GeneratedAndroidWebKit.WebResourceRequestData requestData =
        new GeneratedAndroidWebKit.WebResourceRequestData();
