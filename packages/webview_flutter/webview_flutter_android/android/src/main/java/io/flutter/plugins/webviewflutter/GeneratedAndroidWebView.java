      ...
      } else 
{
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onUrlChanged(Long instanceIdArg, Long webViewInstanceIdArg, String urlArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.onUrlChanged", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, urlArg)), channelReply -> {
        callback.reply(null);
      });
    }
