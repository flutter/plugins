      ...
      } else 
{
  ...
  public interface WebViewHostApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, WebViewHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewHostApi.setScrollListener", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ArrayList wrapped = new ArrayList<>();
            try {
              ...
              api.setScrollListener((instanceIdArg == null) ? null : instanceIdArg.longValue(), (scrollListenerInstanceIdArg == null) ? null : scrollListenerInstanceIdArg.longValue());
              wrapped.add(0, null);
            }
            catch (Error | RuntimeException exception) {
              ArrayList<Object> wrappedError = wrapError(exception);
      ...
      } else 
{
  ...
  public interface ScrollListenerHostApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, ScrollListenerHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ScrollListenerHostApi.create", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ArrayList wrapped = new ArrayList<>();
            try {
  ...
  public static class ScrollListenerFlutterApi {
    ...
    public void onScrollPosChange(@NonNull Long instanceIdArg, @NonNull Long xArg, @NonNull Long yArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ScrollListenerFlutterApi.onScrollPosChange", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg, xArg, yArg)), channelReply -> {
        callback.reply(null);
      });
    }
  }
