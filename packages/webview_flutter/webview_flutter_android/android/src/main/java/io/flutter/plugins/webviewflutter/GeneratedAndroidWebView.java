      ...
      } else 
{
  ...
  public interface WebViewClientHostApi {
    ...
    void setShouldOverrideUrlLoadingReturnValue(@NonNull Long instanceId, @NonNull Boolean value);
    ...
    static void setup(BinaryMessenger binaryMessenger, WebViewClientHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewClientHostApi.setShouldOverrideUrlLoadingReturnValue", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              api.setShouldOverrideUrlLoadingReturnValue((instanceIdArg == null) ? null : instanceIdArg.longValue(), valueArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
