      ...
      } else 
{
  ...
  public interface FileChooserParamsHostApi {
    ...
    static MessageCodec<Object> getCodec() {
      return       new StandardMessageCodec();    }
    /**Sets up an instance of `FileChooserParamsHostApi` to handle messages through the `binaryMessenger`. */
  ...
  public static class FileChooserParamsFlutterApi {
    ...
    public void create(@NonNull Long instanceIdArg, @NonNull Boolean isCaptureEnabledArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.FileChooserParamsFlutterApi.create", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg, isCaptureEnabledArg)), channelReply -> {
        callback.reply(null);
      });
    }
  }
