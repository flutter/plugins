...
public class DownloadListenerHostApiImpl implements GeneratedAndroidWebView.DownloadListenerHostApi {
  ...
  DownloadListenerHostApiImpl(InstanceManager instanceManager, GeneratedAndroidWebView.DownloadListenerFlutterApi downloadListenerFlutterApi) {
  ...
  public void create(Long instanceId) {
    final DownloadListener downloadListener = (url, userAgent, contentDisposition, mimetype, contentLength) -> downloadListenerFlutterApi.onDownloadStart(instanceId,
        url,
        userAgent,
        contentDisposition,
        mimetype,
