...
import 'android_webkit/android_webkit.dart' as android_webkit;

/// Creates a [Widget] with a [android_webkit.WebView].
class WebViewAndroidWidget extends StatefulWidget {
  ...
  const WebViewAndroidWidget({
    ...
    @visibleForTesting
        this.flutterAssetManager = const android_webkit.FlutterAssetManager(),
  });

  /// Initial parameters used to setup the WebView.
  final CreationParams creationParams;

  /// Whether the [android_webkit.WebView] will be rendered with an [AndroidViewSurface].
  ///
  ...
  /// Handles callbacks that are made by [android_webkit.WebViewClient], [android_webkit.DownloadListener], and [android_webkit.WebChromeClient].
  final WebViewPlatformCallbacksHandler callbacksHandler;

  /// Manages named JavaScript channels and forwarding incoming messages on the correct channel.
  final JavascriptChannelRegistry javascriptChannelRegistry;

  /// Handles constructing [android_webkit.WebView]s and calling static methods.
  ///
  ...
  ///
  /// This should only be changed for testing purposes.
  final android_webkit.FlutterAssetManager flutterAssetManager;

  /// Callback to build a widget once [android_webkit.WebView] has been initialized.
...
class WebViewAndroidPlatformController extends WebViewPlatformController {
  ...
  late final android_webkit.WebView webView;
  ...
  /// Handles JavaScript dialogs, favicons, titles, new windows, and the progress for [android_webkit.WebView].
  @visibleForTesting
  late final WebViewAndroidWebChromeClient webChromeClient =
      WebViewAndroidWebChromeClient();

  /// Receive various notifications and requests for [android_webkit.WebView].
  @visibleForTesting
...
class WebViewAndroidJavaScriptChannel extends android_webkit.JavaScriptChannel {
...
/// when a [android_webkit.WebView] attempts to navigate to a new page. If
/// this callback return true, this calls [loadUrl].
class WebViewAndroidDownloadListener extends android_webkit.DownloadListener {
...
/// when a [android_webkit.WebView] attempts to navigate to a new page. If
/// this callback return true, this calls [loadUrl].
class WebViewAndroidWebViewClient extends android_webkit.WebViewClient {
  ...
  /// Callback when [android_webkit.WebViewClient] receives a callback from [android_webkit.WebViewClient].onPageStarted.
  final void Function(String url) onPageStartedCallback;

  /// Callback when [android_webkit.WebViewClient] receives a callback from [android_webkit.WebViewClient].onPageFinished.
  final void Function(String url) onPageFinishedCallback;

  /// Callback when [android_webkit.WebViewClient] receives an error callback.
  ...
  static WebResourceErrorType _errorCodeToErrorType(int errorCode) {
    switch (errorCode) {
      case android_webkit.WebViewClient.errorAuthentication:
        return WebResourceErrorType.authentication;
      case android_webkit.WebViewClient.errorBadUrl:
        return WebResourceErrorType.badUrl;
      case android_webkit.WebViewClient.errorConnect:
        return WebResourceErrorType.connect;
      case android_webkit.WebViewClient.errorFailedSslHandshake:
        return WebResourceErrorType.failedSslHandshake;
      case android_webkit.WebViewClient.errorFile:
        return WebResourceErrorType.file;
      case android_webkit.WebViewClient.errorFileNotFound:
        return WebResourceErrorType.fileNotFound;
      case android_webkit.WebViewClient.errorHostLookup:
        return WebResourceErrorType.hostLookup;
      case android_webkit.WebViewClient.errorIO:
        return WebResourceErrorType.io;
      case android_webkit.WebViewClient.errorProxyAuthentication:
        return WebResourceErrorType.proxyAuthentication;
      case android_webkit.WebViewClient.errorRedirectLoop:
        return WebResourceErrorType.redirectLoop;
      case android_webkit.WebViewClient.errorTimeout:
        return WebResourceErrorType.timeout;
      case android_webkit.WebViewClient.errorTooManyRequests:
        return WebResourceErrorType.tooManyRequests;
      case android_webkit.WebViewClient.errorUnknown:
        return WebResourceErrorType.unknown;
      case android_webkit.WebViewClient.errorUnsafeResource:
        return WebResourceErrorType.unsafeResource;
      case android_webkit.WebViewClient.errorUnsupportedAuthScheme:
        return WebResourceErrorType.unsupportedAuthScheme;
      case android_webkit.WebViewClient.errorUnsupportedScheme:
  ...
  /// Whether this [android_webkit.WebViewClient] handles navigation requests.
  bool get handlesNavigation =>
      loadUrl != null && onNavigationRequestCallback != null;

  @override
  void onPageStarted(android_webkit.WebView webView, String url) {
    onPageStartedCallback(url);
  }

  @override
  void onPageFinished(android_webkit.WebView webView, String url) {
    onPageFinishedCallback(url);
  }

  @override
  void onReceivedError(
    android_webkit.WebView webView,
    int errorCode,
    String description,
    String failingUrl,
  ) {
  ...
  void onReceivedRequestError(
    android_webkit.WebView webView,
    android_webkit.WebResourceRequest request,
    android_webkit.WebResourceError error,
  ) {
  ...
  @override
  void urlLoading(android_webkit.WebView webView, String url) {
...
class WebViewAndroidWebChromeClient extends android_webkit.WebChromeClient {
  // Changed by WebViewAndroidPlatformController.
  void Function(int progress)? _onProgress;

  @override
  void onProgressChanged(android_webkit.WebView webView, int progress) {
    if (_onProgress != null) {
...
class WebViewProxy {
  ...
  /// Constructs a [android_webkit.WebView].
  android_webkit.WebView createWebView({required bool useHybridComposition}) {
    return android_webkit.WebView(useHybridComposition: useHybridComposition);
  }
  ...
  /// [android_webkit.WebView] documentation for the debugging guide. The
  /// default is false.
  ///
  /// See [android_webkit.WebView].setWebContentsDebuggingEnabled.
  Future<void> setWebContentsDebuggingEnabled(bool enabled) {
    return android_webkit.WebView.setWebContentsDebuggingEnabled(true);
  }
}
