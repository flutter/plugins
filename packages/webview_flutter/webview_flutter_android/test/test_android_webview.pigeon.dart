...
abstract class TestFileChooserParamsHostApi {
  ...
  static void setup(TestFileChooserParamsHostApi? api,
      {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.FileChooserParamsHostApi.openFilePickerForResult was null, expected non-null int.');
          final List<String?> output =
              await api.openFilePickerForResult(arg_instanceId!);
          return <Object?>[output];
        });
      }
    }
