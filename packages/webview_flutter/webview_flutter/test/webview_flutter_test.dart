...
//     Set<Factory<OneSequenceGestureRecognizer>>? gestureRecognizers,
//   }) {
//     final int id = _nextPlatformWebViewId++;
//
//     SystemChannels.platform_views.invokeMethod('create', <Object, Object>{
//       'id': id,
//       'params': MethodChannelWebViewPlatform.creationParamsToMap(creationParams),
//     }).then((_) {
...
//   }
//
//   void doSomething(int id, Map<dynamic, dynamic> params) {
//     lastCreatedView = FakePlatformWebView(id, params);
//   }
//
//   void reset() {
