    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.WKWebViewHostApi.setAllowsLinkPreview was null, expected non-null int.');
          final bool? arg_allow = (args[1] as bool?);
          assert(arg_allow != null,
              'Argument for dev.flutter.pigeon.WKWebViewHostApi.setAllowsLinkPreview was null, expected non-null bool.');
