...
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.propertyKeys ? self.propertyKeys : [NSNull null]), @"propertyKeys", (self.propertyValues ? self.propertyValues : [NSNull null]), @"propertyValues", nil];
}
@end
