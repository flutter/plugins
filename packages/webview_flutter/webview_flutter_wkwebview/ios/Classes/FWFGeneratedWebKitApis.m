...
- (void)didFinishNavigationForDelegateWithIdentifier:(NSNumber *)arg_instanceId webViewIdentifier:(NSNumber *)arg_webViewInstanceId URL:(nullable NSString *)arg_url completion:(void(^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
  ...
  [channel sendMessage:@[(arg_instanceId == nil) ? [NSNull null] : arg_instanceId, (arg_webViewInstanceId == nil) ? [NSNull null] : arg_webViewInstanceId, (arg_url == nil) ? [NSNull null] : arg_url] reply:^(id reply) {
    completion(nil);
  }];
}
@end
