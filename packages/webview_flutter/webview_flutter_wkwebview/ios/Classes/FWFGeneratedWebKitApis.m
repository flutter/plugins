  ...
  }
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        [api removeDataFromDataStoreWithIdentifier:arg_instanceId ofTypes:arg_dataTypes modifiedSince:arg_modificationTimeInSecondsSinceEpoch completion:^(NSNumber *_Nullable output, FlutterError *_Nullable error) {
  ...
  }
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        ...
        FlutterError *error;
        [api scrollByForScrollViewWithIdentifier:arg_instanceId x:arg_x y:arg_y error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
...
void FWFWKNavigationDelegateHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKNavigationDelegateHostApi> *api) {
  {
    ...
    if (api) {
      NSCAssert([api respondsToSelector:@selector(createWithIdentifier:didFinishNavigationIdentifier:error:)], @"FWFWKNavigationDelegateHostApi api (%@) doesn't respond to @selector(createWithIdentifier:didFinishNavigationIdentifier:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSNumber *arg_instanceId = GetNullableObjectAtIndex(args, 0);
        NSNumber *arg_didFinishNavigationInstanceId = GetNullableObjectAtIndex(args, 1);
        FlutterError *error;
        [api createWithIdentifier:arg_instanceId didFinishNavigationIdentifier:arg_didFinishNavigationInstanceId error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
...
- (void)didFinishNavigationFunctionWithIdentifier:(NSNumber *)arg_functionInstanceId webViewIdentifier:(NSNumber *)arg_webViewInstanceId URL:(nullable NSString *)arg_url completion:(void(^)(NSError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
