...
- (void)createInstanceId:(NSNumber *)instanceId
    configurationInstanceId:(NSNumber *)configurationInstanceId
                      error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setUIDelegateInstanceId:(NSNumber *)instanceId
...
- (void)loadHtmlStringInstanceId:(NSNumber *)instanceId
                         ...
                         baseUrl:(nullable NSString *)baseUrl
                           error:(FlutterError *_Nullable *_Nonnull)error;
- (void)loadFileUrlInstanceId:(NSNumber *)instanceId
                          url:(NSString *)url
                readAccessUrl:(NSString *)readAccessUrl
                        error:(FlutterError *_Nullable *_Nonnull)error;
- (void)loadFlutterAssetInstanceId:(NSNumber *)instanceId
                               key:(NSString *)key
                             error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
...
- (nullable NSNumber *)canGoForwardInstanceId:(NSNumber *)instanceId
                                        error:(FlutterError *_Nullable *_Nonnull)error;
- (void)goBackInstanceId:(NSNumber *)instanceId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)goForwardInstanceId:(NSNumber *)instanceId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)reloadInstanceId:(NSNumber *)instanceId error:(FlutterError *_Nullable *_Nonnull)error;
- (nullable NSString *)getTitleInstanceId:(NSNumber *)instanceId
                                    error:(FlutterError *_Nullable *_Nonnull)error;
