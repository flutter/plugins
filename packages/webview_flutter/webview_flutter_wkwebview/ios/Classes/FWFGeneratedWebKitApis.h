...
- (void)didFinishNavigationForDelegateWithIdentifier:(NSNumber *)instanceId webViewIdentifier:(NSNumber *)webViewInstanceId URL:(nullable NSString *)url completion:(void(^)(NSError *_Nullable))completion;
@end
