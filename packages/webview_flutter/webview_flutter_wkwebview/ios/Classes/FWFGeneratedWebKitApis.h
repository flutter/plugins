...
- (void)removeDataFromDataStoreWithIdentifier:(NSNumber *)instanceId ofTypes:(NSArray<FWFWKWebsiteDataTypeEnumData *> *)dataTypes modifiedSince:(NSNumber *)modificationTimeInSecondsSinceEpoch completion:(void(^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)scrollByForScrollViewWithIdentifier:(NSNumber *)instanceId x:(NSNumber *)x y:(NSNumber *)y error:(FlutterError *_Nullable *_Nonnull)error;
...
- (void)createWithIdentifier:(NSNumber *)instanceId didFinishNavigationIdentifier:(nullable NSNumber *)didFinishNavigationInstanceId error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)didFinishNavigationFunctionWithIdentifier:(NSNumber *)functionInstanceId webViewIdentifier:(NSNumber *)webViewInstanceId URL:(nullable NSString *)url completion:(void(^)(NSError *_Nullable))completion;
@end
