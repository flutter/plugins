...
- (NSArray<NSNumber *> *)contentOffsetForScrollViewWithIdentifier:(nonnull NSNumber *)instanceId error:(FlutterError *_Nullable *_Nonnull)error {
...
[scrollView
 setContentOffset:CGPointMake(contentOffset.x + x.doubleValue, contentOffset.y + y.doubleValue)];
}

- (void)setContentOffsetForScrollViewWithIdentifier:(nonnull NSNumber *)instanceId             toX:(nonnull  NSNumber *)x
                                                  y:(nonnull NSNumber *)y
                          error:(FlutterError *_Nullable *_Nonnull)error {
  
[[self scrollViewForIdentifier:instanceId] setContentOffset
