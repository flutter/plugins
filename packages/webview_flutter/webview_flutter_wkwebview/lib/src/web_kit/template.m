...
- (/*if customValues_isProtocol*/
     ...
     __name__
     /**/
 *)/*replace :case=camel customValues_nameWithoutPrefix*/name/**/ForIdentifier:(NSNumber *)instanceId {
  return (
  /*if customValues_isProtocol*/
    FWF__customValues_nameWithoutPrefix__
    /**/
...
- (void)createWithIdentifier:(nonnull NSNumber *)instanceId
  ...
  */*replace :case=camel customValues_nameWithoutPrefix*/name/**/ =
  ...
  /*if! customValues_isProtocol*/
   [[__name__ alloc] init];
  /**/
  [self.instanceManager addInstance:/*replace :case=camel customValues_nameWithoutPrefix*/name/**/ withIdentifier:instanceId.longValue];
}
...
- (void)createFromWebViewConfigurationWithIdentifier:(nonnull NSNumber *)instanceId
  ...
  [self.instanceManager addInstance:configuration./*replace :case=camel customValues_nameWithoutPrefix*/name/**/ withIdentifier:instanceId.longValue];
}

/*iterate methods method*/
- (void)__customValues_objcName__:(nonnull NSNumber *)instanceId
/*iterate parameters parameter*/
                __name__:(/*if type_nullable*/nullable/**//*if! type_nullable*/nonnull/**/ __type_customValues_objcName__ *)__name__
/**/
                            error:(FlutterError *_Nullable *_Nonnull) error {
  /*if! customValues_returnsVoid*/return/**/
  [[self /*replace :case=camel class_customValues_nameWithoutPrefix*/name/**/ForIdentifier:instanceId] __name__
