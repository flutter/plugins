...
/**
 * Converts an FWFNSKeyValueObservingOptionsEnumData to an
 * NSKeyValueObservingOptions.
 *
 * @param data The data object containing information to create an
 * NSKeyValueObservingOptions.
 *
 ...
 */
extern NSKeyValueChange FWFNSKeyValueChangeFromEnumData(
    FWFNSKeyValueChangeEnumData* data);
 ...
 */
extern NSKeyValueChangeKey FWFNSKeyValueChangeKeyFromEnumData(
    FWFNSKeyValueChangeKeyEnumData* data);
 ...
 */
extern NSHttpCookiePropertyKey FWFNSHttpCookiePropertyKeyFromEnumData(
