...
class NSErrorData {
  NSErrorData({
    ...
    required this.localiziedDescription,
  });

  int code;
  String domain;
  String localiziedDescription;

  Object encode() {
    final Map<Object?, Object?> pigeonMap = <Object?, Object?>{};
    pigeonMap['code'] = code;
    pigeonMap['domain'] = domain;
    pigeonMap['localiziedDescription'] = localiziedDescription;
    return pigeonMap;
  }
  ...
  static NSErrorData decode(Object message) {
    ...
    return NSErrorData(
      ...
      localiziedDescription: pigeonMap['localiziedDescription']! as String,
    );
  }
}
