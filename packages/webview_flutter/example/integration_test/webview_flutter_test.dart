...
void main() {
        ...
        <head><title>Video auto play</title>
          <script type="text/javascript">
            ...
            function videoPausePlayHandler(e) {
              ...
              // if (e.type == 'play') {
              //   VideoTest.postMessage("play");
              // } else if (e.type == 'pause') {
              //   VideoTest.postMessage("pause");
              // } else if (e.type == 'durationchange') {
              //   VideoTest.postMessage("durationchange");
              // } else if (e.type == 'loadeddata') {
              //   VideoTest.postMessage("loadeddata");
              // } else if (e.type == 'timeupdate') {
              //   VideoTest.postMessage("timeupdate");
              // }
            }
            function isPaused() {
              var video = document.getElementById("video");
  ...
  //   }, skip: true /* https://github.com/flutter/flutter/issues/72572 */);
    ...
    testWidgets('Video plays full screen when allowsInlineMediaPlayback is false',
      ...
      Completer<void> pageLoaded = Completer<void>();
      String message1;
      Completer<String> messagesReceived = Completer<String>();
      ...
      WebViewController controller = await controllerCompleter.future;
      await pageLoaded.future;
      // String message = await messagesReceived.future;
      // print(message1);

      String duration =
          await controller.evaluateJavascript('currentTime();');
      // print(duration);
