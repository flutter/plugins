...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    [channel setMethodCallHandler:^(FlutterMethodCall *call,
      ...
      if ([method isEqualToString:@"getAll"]) {
        ...
        NSString *key = arguments[@"key"];
        NSNumber *value = arguments[@"value"];
        [[NSUserDefaults standardUserDefaults] setInteger:value.intValue
                                                   forKey:key];
        result(nil);
      } else if ([method isEqualToString:@"setDouble"]) {
        NSString *key = arguments[@"key"];
        NSNumber *value = arguments[@"value"];
        [[NSUserDefaults standardUserDefaults] setDouble:value.doubleValue
                                                  forKey:key];
        result(nil);
        ...
        result([NSNumber numberWithBool:[[NSUserDefaults standardUserDefaults]
                                            synchronize]]);
