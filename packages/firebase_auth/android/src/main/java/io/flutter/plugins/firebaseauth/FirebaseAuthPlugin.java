...
public class FirebaseAuthPlugin implements MethodCallHandler {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    switch (call.method) {
      ...
      case "signInWithGithub":
        handleSignInWithGithub(call, result);
        break;
      case "signOut":
      ...
      case "linkWithGithubCredential":
        handleLinkWithGithubCredential(call, result);
        break;
      case "updateProfile":
  ...
  private void handleLinkWithGithubCredential(MethodCall call, final Result result) {
  ...
  private void handleSignInWithGithub(MethodCall call, final Result result) {
    String token = call.argument("token");
    AuthCredential credential = GithubAuthProvider.getCredential(token);
    firebaseAuth
        .signInWithCredential(credential)
